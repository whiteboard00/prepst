...
export function StatisticsPanel({
  ...
  return (
    <div className="w-96 p-6 flex-shrink-0 bg-white rounded-3xl shadow-sm">
      <h2 className="text-3xl font-bold mb-8 text-gray-900">Study Statistics</h2>
      ...
      {studyStats && (
        <div className="mb-8">
            ...
            <Card className="p-4 bg-green-50 border-green-100">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold text-green-900">{studyStats.currentStreak} days</p>
                </div>
              </div>
            </Card>
            <Card className="p-4 bg-purple-50 border-purple-100">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold text-purple-900">{studyStats.sessionsCompleted}</p>
                </div>
              </div>
            </Card>
            <Card className="p-4 bg-orange-50 border-orange-100">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold text-orange-900">{studyStats.averageScore}%</p>
                </div>
              </div>
            </Card>
          </div>
          ...
          <div className="mb-4">
            <h4 className="text-sm font-semibold text-gray-700 mb-3">Daily Study Time</h4>
