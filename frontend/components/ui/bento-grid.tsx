...
const bentoItems: BentoItem[] = [
    {
        id: "main",
        title: "Cognition, Not Content",
        description:
            "Our competitors are in the content business. We are in the cognition business.",
        href: "#",
        feature: "spotlight",
        spotlightItems: [
            "Model your brain",
    ...
    {
        id: "stat1",
        title: "The Learning Atlas",
        description:
            "Building the world's first atlas of the human learning process",
        href: "#",
        feature: "typing",
        typingText:
            "// Our data isn't about quadratic equations\n// It's about 10,000 different ways\n// a human mind can fail to grasp it,\n// and 100 different ways it can be taught\n// so that it finally clicks.\n\nconst optimizeLearning = (student) => {\n  const cognitiveProfile = modelBrain(student);\n  const blocks = identifyBlocks(cognitiveProfile);\n  const intervention = findOptimalPath(blocks);\n  \n  return intervention;\n};",
        size: "md",
    ...
    },
    {
        ...
        description:
            "Digital education is broken. It's a content-delivery business, not a learning business.",
        href: "#",
        feature: "metrics",
        metrics: [
            { label: "Right stimulus", value: 100, suffix: "%", color: "emerald" },
            { label: "Right time", value: 100, suffix: "%", color: "blue" },
            { label: "Right way", value: 100, suffix: "%", color: "violet" },
        ],
        size: "md",
    ...
    },
    {
        ...
        title: "The Problem",
        description:
            "Current platforms can tell you what you got wrong, but they have no idea why.",
        href: "#",
        feature: "timeline",
        timeline: [
            { year: "Old Way", event: "Content delivery without understanding" },
            { year: "Problem", event: "Frustrating plateaus and wasted effort" },
            { year: "Issue", event: "Wrong interventions for each student" },
            { year: "Our Way", event: "Cognitive modeling and personalization" },
            { year: "Result", event: "Near-continuous improvement" },
        ],
        size: "sm",
        className: "col-span-1 row-span-1",
    },
