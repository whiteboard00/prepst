...
import type { SessionQuestion, AnswerState, AIFeedbackContent } from '@/lib/types';
            ...
            >
              {(() => {
                ...
                return options.map((option: unknown, index: number) => {
                  ...
                  const isCorrect = showFeedback && answer?.isCorrect && isSelected;
                  const isWrong = showFeedback && !answer?.isCorrect && isSelected;
