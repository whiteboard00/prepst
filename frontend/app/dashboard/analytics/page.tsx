                    ...
                    {skill.plateau && (
                      <div className="mt-2 p-2 bg-orange-50 border border-orange-200 rounded text-xs">
                        ...
                        <p className="text-orange-700">
                          Try a different approach: watch a video explanation,
                          practice easier questions first, or take a break and
                          return later.
                        </p>
                      </div>
                    )}
                    ...
                    {skill.velocity < -0.02 && !skill.plateau && (
                      <div className="mt-2 p-2 bg-red-50 border border-red-200 rounded text-xs">
                        ...
                        <p className="text-red-700">
                          Consider reviewing prerequisite topics or seeking
                          additional help with foundational concepts.
                        </p>
                      </div>
                    )}
                    ...
                    {skill.velocity > 0.05 && (
                      <div className="mt-2 p-2 bg-green-50 border border-green-200 rounded text-xs">
                        <p className="text-green-700">
                          ✨ Great momentum! Keep practicing to solidify this
                          skill.
                        </p>
                      </div>
                    )}
